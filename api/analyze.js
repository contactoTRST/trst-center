...
function scoreToVerdict(score, layers) {
  ...
  if (isSynthetic) return { label: "Likely AI-Functioned", color: "red", recommendation: "Strong signals indicate this image was entirely generated by AI with no real photographic source. TRST does not recommend publishing." };
